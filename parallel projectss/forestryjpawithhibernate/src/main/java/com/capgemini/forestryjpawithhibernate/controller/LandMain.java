...
public class LandMain {
	...
	public static void landMain()  {
		...
		while(true) {
			...
			System.out.println("press 5 : Get All Lands Details");
			...
			case 1:
				...
				try {
					if(landservices.addLandDetails(bean1)) {
			...
			case 3:
				...
				try {
					...
					if(bean1!=null) {
						...
						System.out.println("Land Details Updated!! Check the Land Details");
					}
				} catch (NotFoundException e) {
